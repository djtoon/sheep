...
def bass_line(chords, pats):
    ...
    for b in range(len(chords)):
        p = (pats[b] if isinstance(pats, list) else pats).split()
...
def render_music():
    loops = {}
    for key, fn, lufs in [('music-stage1', stage1, -15), ('music-title', title, -15), ('music-boss', boss, -14.5)]:
    ...
    for key, fn, lufs in [('sting-clear', sting_clear, -14), ('sting-gameover', sting_gameover, -16), ('sting-warning', sting_warning, -13), ('sting-continue', sting_continue, -14)]:
